...
public class QRCodeParams {
    private String txt = "熊哥,发红包!!";                                                       //二维码内容
    private String qrCodeUrl;                                                                   //二维码网络路径
    private String filePath = "/Users/lidongliang/project/JavaPro/";                             //二维码生成物理路径
    private String fileName = "QR.jpg";                                                       //二维码生成图片名称（包含后缀名）
    private String logoPath = "/Users/lidongliang/project/JavaPro/img.jpg";             //logo图片
    ...
    private ErrorCorrectionLevel level = ErrorCorrectionLevel.Q;  //二维码容错率
